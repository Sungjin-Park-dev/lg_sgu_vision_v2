...
`scene.py`와 같은 워크셀을 띄우고, Omni.UI 패널(Mode / Generate / Preview / Publish)로
...
uv run scripts/core/publish_trajectory.py --csv data/sample/trajectory/124/trajectory.csv
```
