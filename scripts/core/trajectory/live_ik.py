...
지금은 `apps/trajectory_studio.py` 가 import 한다.
...
from core import trajectory as PT              # noqa: E402  (헤비: curobo import)
...
class IKBackend:
    ...
    def __init__(self, object_name: str):
        self.robot_cfg = PT.resolve_robot_config(config.DEFAULT_ROBOT_CONFIG)
