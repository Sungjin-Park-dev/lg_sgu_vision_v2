...
Usage:
    uv run scripts/isaac/load_workcell.py
"""
...
print(f"[load_workcell] Robot frame == world origin")
print(f"[load_workcell] Environment offset: {ENV_OFFSET.tolist()}")
print("[load_workcell] Bounding boxes (world coords, meters):")
