...
object on the stage. Run this once for a new object, or again after changing
its source.obj, so it can be loaded from the Pipeline UI's Object dropdown.
...
Usage:
    ...
    uv run scripts/setup/build_object_usd.py --object glass --force
"""
