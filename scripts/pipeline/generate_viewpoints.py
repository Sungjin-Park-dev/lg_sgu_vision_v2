...
사용법:
    ...
    uv run scripts/pipeline/generate_viewpoints.py --object sample --material-rgb "170,163,158" --cluster-method coacd+dbscan --normal-weight 0.05 --coacd-threshold 0.25 --eps 25
